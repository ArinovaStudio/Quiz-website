      ...
      <div className=" px-6">
        <div className="flex flex-col md:flex-row items-center text-center justify-between gap-4">
          ...
          <div className="flex max-md:flex-col gap-4">
            ...
            <Link href={"/gaming-policy"} className="text-background/70 hover:text-background font-bold text-sm uppercase">Responsible Gaming Policy</Link> <span className="mx-2 text-background/70 max-md:hidden">|</span>
            <Link href={"/delete-my-account"} className="text-background/70 hover:text-background font-bold text-sm uppercase">Delete Account</Link>
          </div>
        </div>
