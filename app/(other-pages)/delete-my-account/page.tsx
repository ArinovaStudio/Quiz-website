...
//   return (
//       <Card
//         className="w-full max-w-sm mx-auto my-2 border-[4px] border-black rounded-[16px]"
...
import  {DeleteAccountIllustration} from "./_components/DeleteAccountIllustration";
...
const Index = () => {
  return (
    ...
    >
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-0 border-2 border-foreground shadow-neo-lg overflow-hidden">
